...
class Cycle2ViewController: TestViewController {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        observer = NotificationCenter.default.addObserver(forName: NSNotification.Name.UIApplicationWillResignActive, object: nil, queue: OperationQueue.main) { notification in
